...
// === ANFRAGE (2) ===
export const p01: Project = buildProject({
  id: 'p01',
  number: '2026-051',
...
export const p02: Project = buildProject({
  id: 'p02',
  number: '2026-042',
...
// === ANGEBOT (2) ===
export const p03: Project = buildProject({
  id: 'p03',
  number: '2026-040',
...
export const p04: Project = buildProject({
  id: 'p04',
  number: '2026-035',
...
// === BEAUFTRAGT (2) ===
export const p05: Project = buildProject({
  id: 'p05',
  number: '2026-038',
...
export const p06: Project = buildProject({
  id: 'p06',
  number: '2026-039',
...
// === GEPLANT (2) ===
export const p07: Project = buildProject({
  id: 'p07',
  number: '2026-034',
...
export const p08: Project = buildProject({
  id: 'p08',
  number: '2026-033',
...
// === IN ARBEIT (3) ===
export const p09: Project = buildProject({
  id: 'p09',
  number: '2026-028',
...
export const p10: Project = buildProject({
  id: 'p10',
  number: '2026-030',
...
export const p11: Project = buildProject({
  id: 'p11',
  number: '2026-029',
...
// === ABNAHME (1) ===
export const p12: Project = buildProject({
  id: 'p12',
  number: '2026-025',
...
export const p13: Project = buildProject({
  id: 'p13',
  number: '2026-022',
...
export const p14: Project = buildProject({
  id: 'p14',
  number: '2026-020',
...
export const p15: Project = buildProject({
  id: 'p15',
  number: '2026-018',
...
// === ABGERECHNET (2) ===
export const p16: Project = buildProject({
  id: 'p16',
  number: '2026-015',
...
export const p17: Project = buildProject({
  id: 'p17',
  number: '2026-012',
...
// === ERLEDIGT (2) ===
export const p18: Project = buildProject({
  id: 'p18',
  number: '2026-008',
...
export const p19: Project = buildProject({
  id: 'p19',
  number: '2026-005',
