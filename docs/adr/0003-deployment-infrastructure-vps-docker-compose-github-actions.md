...
| Caddy                             | 2.11.3 (security-bumped 2026-05-15 per [#187](https://github.com/vlzware/Projekt-Manager/issues/187)) | Apache-2.0, Stack Holdings / Light Code Labs, very active. `caddy-dns/cloudflare` plugin pinned by commit SHA (HEAD on `main`).                                                                                                                                                                             |
