...
| `@aws-sdk/client-s3` + `@aws-sdk/s3-request-presigner` | 3.1047.0 (2026-05-14), Apache-2.0, AWS very active | The bucket primitives are exercised via the standard S3 SDK; no B2-specific SDK. Lockstep-bumped under [ADR-0027](0027-continuous-dependency-updates-with-supply-chain-scanning.md).                                                                                              |
