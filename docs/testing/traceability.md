...
| AC-25 | [crit] | §15.4  | Abmelden → login screen               |              |              | smoke.spec.ts AC-25, kanban-flows.spec.ts AC-25             |                                      |
| AC-26 | [crit] | §15.4  | Back button after logout safe         |              |              | kanban-flows.spec.ts AC-26                                  |                                      |
...
| AC-29 | [vis]  | §15.5  | Multi-user concurrent visibility      |              |              | auth.test.ts AC-29 block                                    | API integration test, no AT ID       |
...
| AC-45 | [crit] | §15.6  | HTTPS default + refusal + banner      |              |              | env.test.ts (assertProductionSafe), insecure-banner.spec.ts | Multi-surface; banner pinned via E2E |
