...
| Role       | Permissions                                                                                                                                                                                                                                          |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| owner      | project:read, project:transition, project:dates, project:create, project:update, project:delete, project:purge, customer:read, customer:write, customer:delete, user:read, user:manage, user:delete, data:export, data:restore, auth:change-password |
