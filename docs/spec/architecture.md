...
- Export-all mobile-warning breakpoint — viewport width (CSS px) below which the `Vollständiger Export` pre-flight dialog renders the `"Für Desktop-Nutzung gedacht; Downloads können sehr groß sein."` warning. Default 480; the warning is non-blocking — the user may proceed regardless ([ui/daten.md §8.11.3](ui/daten.md#8113-vollständiger-export), [verification.md AC-249](verification.md#1514-data-exchange))
