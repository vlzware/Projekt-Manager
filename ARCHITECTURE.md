...
| `src/state/`               | Zustand stores (`authStore`, `auditStore`, `confirmStore`, `customerStore`, `dataExchangeStore`, `extractionActions`, `notificationRuleStore`, `projectManagementStore`, `projectStore`, `sessionExpired`, `uiStore`, `userStore`), barrel re-export (`store.ts`), client-side cache                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Access the database or import server code               |
