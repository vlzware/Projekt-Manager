...
**Retention is linear, not GFS:** bucket lock for 14 days, lifecycle delete at 90 days. No weekly/monthly promotion. This is a deliberate scope call — see [ADR-0020 §Decision](docs/adr/0020-layer-2-encrypted-r2-backups-with-operator-loaded-drills.md#decision).
